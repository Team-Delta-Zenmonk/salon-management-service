...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const bookingDesc = await queryInterface.describeTable("bookings");
    if (bookingDesc.rescheduled_at)
      await queryInterface.removeColumn("bookings", "rescheduled_at");
    if (bookingDesc.reschedule_count)
      await queryInterface.removeColumn("bookings", "reschedule_count");
    if (bookingDesc.is_walk_in)
      await queryInterface.removeColumn("bookings", "is_walk_in");
    ...
    await queryInterface.sequelize
      .query('DROP TYPE IF EXISTS "enum_bookings_payment_policy" CASCADE;')
      .catch(() => {});
  },
};
